...
describe ArrayDataAnalysis do
  let(:analyzer) { ArrayDataAnalysis.new(TEMPERATURE_DATA) } #instantiate a new object (:analyzer) and pass TEMPERATURE_DATA as a parameter to the initialize method of the class
